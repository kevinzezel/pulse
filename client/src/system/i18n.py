CATALOGS = {
    "pt-BR": {
        ...
        "errors.editor_binary_not_found": "Binário do VS Code não encontrado no host. Instale 'code' no sistema ou verifique o PATH.",
    ...
    "en": {
        ...
        "errors.editor_binary_not_found": "VS Code binary not found on host. Install 'code' on the system or check PATH.",
    ...
    "es": {
        ...
        "errors.editor_binary_not_found": "Binario de VS Code no encontrado en el host. Instala 'code' o revisa el PATH.",
